...
((g) => {
  ((u) => {
    u[u.UNSPECIFIED = 0] = "UNSPECIFIED", u[u.OUTPUT_DATA = 1] = "OUTPUT_DATA", u[u.END = 2] = "END";
  ...
  class h extends i.Message {
    ...
    get css() {
      return i.Message.getWrapperField(this, h.CssProperties, 5);
    }
    set css(e) {
    ...
    get previewImage() {
      return i.Message.getWrapperField(this, h.PreviewImage, 15);
    }
    set previewImage(e) {
    ...
    static fromObject(e) {
      const r = new h({});
      return e.input != null && (r.input = e.input), e.outDir != null && (r.outDir = e.outDir), e.css != null && (r.css = h.CssProperties.fromObject(e.css)), e.targetType != null && (r.targetType = e.targetType), e.subsets != null && (r.subsets = e.subsets), e.chunkSize != null && (r.chunkSize = e.chunkSize), e.chunkSizeTolerance != null && (r.chunkSizeTolerance = e.chunkSizeTolerance), e.maxAllowSubsetsCount != null && (r.maxAllowSubsetsCount = e.maxAllowSubsetsCount), e.testHtml != null && (r.testHtml = e.testHtml), e.reporter != null && (r.reporter = e.reporter), e.previewImage != null && (r.previewImage = h.PreviewImage.fromObject(e.previewImage)), e.renameOutputFont != null && (r.renameOutputFont = e.renameOutputFont), e.buildMode != null && (r.buildMode = e.buildMode), e.languageAreas != null && (r.languageAreas = e.languageAreas), e.multiThreads != null && (r.multiThreads = e.multiThreads), e.fontFeature != null && (r.fontFeature = e.fontFeature), e.reduceMins != null && (r.reduceMins = e.reduceMins), e.autoSubset != null && (r.autoSubset = e.autoSubset), e.subsetRemainChars != null && (r.subsetRemainChars = e.subsetRemainChars), r;
    }
    toObject() {
      const e = {};
    ...
    serialize(e) {
      const r = e || new i.BinaryWriter();
      if (this.input.length && r.writeBytes(1, this.input), this.hasOutDir && r.writeString(2, this.outDir), this.hasCss && r.writeMessage(5, this.css, () => this.css.serialize(r)), this.hasTargetType && r.writeString(6, this.targetType), this.subsets.length && r.writeRepeatedBytes(7, this.subsets), this.hasChunkSize && r.writeInt32(9, this.chunkSize), this.hasChunkSizeTolerance && r.writeFloat(10, this.chunkSizeTolerance), this.hasMaxAllowSubsetsCount && r.writeInt32(11, this.maxAllowSubsetsCount), this.hasTestHtml && r.writeBool(13, this.testHtml), this.hasReporter && r.writeBool(14, this.reporter), this.hasPreviewImage && r.writeMessage(15, this.previewImage, () => this.previewImage.serialize(r)), this.hasRenameOutputFont && r.writeString(18, this.renameOutputFont), this.hasBuildMode && r.writeString(20, this.buildMode), this.hasLanguageAreas && r.writeBool(8, this.languageAreas), this.hasMultiThreads && r.writeBool(21, this.multiThreads), this.hasFontFeature && r.writeBool(22, this.fontFeature), this.hasReduceMins && r.writeBool(23, this.reduceMins), this.hasAutoSubset && r.writeBool(24, this.autoSubset), this.hasSubsetRemainChars && r.writeBool(25, this.subsetRemainChars), !e)
        return r.getResultBuffer();
    }
    static deserialize(e) {
      const r = e instanceof i.BinaryReader ? e : new i.BinaryReader(e), l = new h();
      for (; r.nextField() && !r.isEndGroup(); )
        switch (r.getFieldNumber()) {
          case 1:
            ...
            break;
          case 2:
            l.outDir = r.readString();
            break;
          case 5:
            r.readMessage(l.css, () => l.css = h.CssProperties.deserialize(r));
            break;
          case 6:
            l.targetType = r.readString();
            break;
          case 7:
            i.Message.addToRepeatedField(l, 7, r.readBytes());
            break;
          case 9:
            l.chunkSize = r.readInt32();
            break;
          case 10:
            l.chunkSizeTolerance = r.readFloat();
            break;
          case 11:
            l.maxAllowSubsetsCount = r.readInt32();
            break;
          case 13:
            l.testHtml = r.readBool();
            break;
          case 14:
            l.reporter = r.readBool();
            break;
          case 15:
            r.readMessage(l.previewImage, () => l.previewImage = h.PreviewImage.deserialize(r));
            break;
          case 18:
            l.renameOutputFont = r.readString();
            break;
          case 20:
            l.buildMode = r.readString();
            break;
          case 8:
            l.languageAreas = r.readBool();
            break;
          case 21:
            l.multiThreads = r.readBool();
            break;
          case 22:
            l.fontFeature = r.readBool();
            break;
          case 23:
            l.reduceMins = r.readBool();
            break;
          case 24:
            l.autoSubset = r.readBool();
            break;
          case 25:
            l.subsetRemainChars = r.readBool();
            break;
          default:
            r.skipField();
        }
  ...
  g.InputTemplate = h, ((u) => {
    class e extends i.Message {
      ...
      get polyfill() {
        return i.Message.getRepeatedWrapperField(this, u.PolyfillType, 6);
      }
      set polyfill(t) {
      ...
      static fromObject(t) {
        const s = new e({});
        return t.fontFamily != null && (s.fontFamily = t.fontFamily), t.fontWeight != null && (s.fontWeight = t.fontWeight), t.fontStyle != null && (s.fontStyle = t.fontStyle), t.fontDisplay != null && (s.fontDisplay = t.fontDisplay), t.localFamily != null && (s.localFamily = t.localFamily), t.polyfill != null && (s.polyfill = t.polyfill.map((n) => u.PolyfillType.fromObject(n))), t.commentBase != null && (s.commentBase = t.commentBase), t.commentNameTable != null && (s.commentNameTable = t.commentNameTable), t.commentUnicodes != null && (s.commentUnicodes = t.commentUnicodes), t.compress != null && (s.compress = t.compress), t.fileName != null && (s.fileName = t.fileName), s;
      }
      toObject() {
        const t = {};
    ...
    class r extends i.Message {
      ...
      static deserialize(t) {
        const s = t instanceof i.BinaryReader ? t : new i.BinaryReader(t), n = new r();
        for (; s.nextField() && !s.isEndGroup(); )
          switch (s.getFieldNumber()) {
            case 1:
              n.name = s.readString();
    ...
    class l extends i.Message {
      ...
      static deserialize(t) {
        const s = t instanceof i.BinaryReader ? t : new i.BinaryReader(t), n = new l();
        for (; s.nextField() && !s.isEndGroup(); )
          switch (s.getFieldNumber()) {
            case 1:
              n.text = s.readString();
    ...
    u.PreviewImage = l;
  })(h = g.InputTemplate || (g.InputTemplate = {}));
  class f extends i.Message {
    ...
    static fromObject(e) {
      const r = new f({});
      return e.event != null && (r.event = e.event), e.message != null && (r.message = e.message), e.data != null && (r.data = e.data), r;
    }
    toObject() {
      const e = {};
    ...
    serialize(e) {
      const r = e || new i.BinaryWriter();
      if (this.event != 0 && r.writeEnum(1, this.event), this.message.length && r.writeString(2, this.message), this.hasData && r.writeBytes(3, this.data), !e)
        return r.getResultBuffer();
    }
    static deserialize(e) {
      const r = e instanceof i.BinaryReader ? e : new i.BinaryReader(e), l = new f();
      for (; r.nextField() && !r.isEndGroup(); )
        switch (r.getFieldNumber()) {
          case 1:
            l.event = r.readEnum();
  ...
  class c extends i.Message {
    ...
    static fromObject(e) {
      const r = new c({});
      return e.messages != null && (r.messages = e.messages.map((l) => f.fromObject(l))), r;
    }
    toObject() {
      const e = {};
      return this.messages != null && (e.messages = this.messages.map((r) => r.toObject())), e;
    }
    serialize(e) {
      const r = e || new i.BinaryWriter();
      if (this.messages.length && r.writeRepeatedMessage(1, this.messages, (l) => l.serialize(r)), !e)
        return r.getResultBuffer();
    }
    static deserialize(e) {
      const r = e instanceof i.BinaryReader ? e : new i.BinaryReader(e), l = new c();
      for (; r.nextField() && !r.isEndGroup(); )
        switch (r.getFieldNumber()) {
          case 1:
            r.readMessage(l.messages, () => i.Message.addToRepeatedWrapperField(l, 1, f.deserialize(r), f));
            break;
          default:
            r.skipField();
        }
  ...
  class o extends i.Message {
    ...
    get css() {
      return i.Message.getWrapperField(this, o.Css, 2);
    }
    set css(e) {
    ...
    get bundleMessage() {
      return i.Message.getWrapperField(this, o.BundleMessage, 24);
    }
    set bundleMessage(e) {
    ...
    get nameTable() {
      return i.Message.getRepeatedWrapperField(this, o.NameTable, 25);
    }
    set nameTable(e) {
      i.Message.setRepeatedWrapperField(this, 25, e);
    }
    get subsetDetail() {
      return i.Message.getRepeatedWrapperField(this, o.SubsetDetail, 26);
    }
    set subsetDetail(e) {
    ...
    static fromObject(e) {
      const r = new o({});
      return e.version != null && (r.version = e.version), e.css != null && (r.css = o.Css.fromObject(e.css)), e.platform != null && (r.platform = e.platform), e.bundleMessage != null && (r.bundleMessage = o.BundleMessage.fromObject(e.bundleMessage)), e.nameTable != null && (r.nameTable = e.nameTable.map((l) => o.NameTable.fromObject(l))), e.subsetDetail != null && (r.subsetDetail = e.subsetDetail.map((l) => o.SubsetDetail.fromObject(l))), r;
    }
    toObject() {
      const e = {};
      return this.version != null && (e.version = this.version), this.css != null && (e.css = this.css.toObject()), this.platform != null && (e.platform = this.platform), this.bundleMessage != null && (e.bundleMessage = this.bundleMessage.toObject()), this.nameTable != null && (e.nameTable = this.nameTable.map((r) => r.toObject())), this.subsetDetail != null && (e.subsetDetail = this.subsetDetail.map((r) => r.toObject())), e;
    }
    serialize(e) {
      const r = e || new i.BinaryWriter();
      if (this.version.length && r.writeString(1, this.version), this.hasCss && r.writeMessage(2, this.css, () => this.css.serialize(r)), this.platform.length && r.writeString(3, this.platform), this.hasBundleMessage && r.writeMessage(24, this.bundleMessage, () => this.bundleMessage.serialize(r)), this.nameTable.length && r.writeRepeatedMessage(25, this.nameTable, (l) => l.serialize(r)), this.subsetDetail.length && r.writeRepeatedMessage(26, this.subsetDetail, (l) => l.serialize(r)), !e)
        return r.getResultBuffer();
    }
    static deserialize(e) {
      const r = e instanceof i.BinaryReader ? e : new i.BinaryReader(e), l = new o();
      for (; r.nextField() && !r.isEndGroup(); )
        switch (r.getFieldNumber()) {
          case 1:
            l.version = r.readString();
            break;
          case 2:
            r.readMessage(l.css, () => l.css = o.Css.deserialize(r));
            break;
          case 3:
            l.platform = r.readString();
            break;
          case 24:
            r.readMessage(l.bundleMessage, () => l.bundleMessage = o.BundleMessage.deserialize(r));
            break;
          case 25:
            r.readMessage(l.nameTable, () => i.Message.addToRepeatedWrapperField(l, 25, o.NameTable.deserialize(r), o.NameTable));
            break;
          case 26:
            r.readMessage(l.subsetDetail, () => i.Message.addToRepeatedWrapperField(l, 26, o.SubsetDetail.deserialize(r), o.SubsetDetail));
            break;
          default:
            r.skipField();
        }
  ...
  g.OutputReport = o, ((u) => {
    class e extends i.Message {
      ...
      static fromObject(s) {
        const n = new e({});
        return s.platform != null && (n.platform = s.platform), s.language != null && (n.language = s.language), s.name != null && (n.name = s.name), s.value != null && (n.value = s.value), n;
      }
      toObject() {
        const s = {};
      ...
      serialize(s) {
        const n = s || new i.BinaryWriter();
        if (this.platform.length && n.writeString(1, this.platform), this.language.length && n.writeString(2, this.language), this.name.length && n.writeString(3, this.name), this.value.length && n.writeString(4, this.value), !s)
          return n.getResultBuffer();
      }
      static deserialize(s) {
        const n = s instanceof i.BinaryReader ? s : new i.BinaryReader(s), a = new e();
        for (; n.nextField() && !n.isEndGroup(); )
          switch (n.getFieldNumber()) {
            case 1:
              a.platform = n.readString();
              break;
            case 2:
              a.language = n.readString();
              break;
            case 3:
              a.name = n.readString();
              break;
            case 4:
              a.value = n.readString();
              break;
            default:
              n.skipField();
          }
    ...
    class r extends i.Message {
      ...
      static fromObject(s) {
        const n = new r({});
        return s.id != null && (n.id = s.id), s.hash != null && (n.hash = s.hash), s.fileName != null && (n.fileName = s.fileName), s.bytes != null && (n.bytes = s.bytes), s.chars != null && (n.chars = s.chars), s.duration != null && (n.duration = s.duration), n;
      }
      toObject() {
        const s = {};
      ...
      serialize(s) {
        const n = s || new i.BinaryWriter();
        if (this.id != 0 && n.writeUint32(1, this.id), this.hash.length && n.writeString(2, this.hash), this.fileName.length && n.writeString(6, this.fileName), this.bytes != 0 && n.writeUint32(3, this.bytes), this.chars.length && n.writePackedUint32(4, this.chars), this.duration != 0 && n.writeUint32(5, this.duration), !s)
          return n.getResultBuffer();
      }
      static deserialize(s) {
        const n = s instanceof i.BinaryReader ? s : new i.BinaryReader(s), a = new r();
        for (; n.nextField() && !n.isEndGroup(); )
          switch (n.getFieldNumber()) {
            case 1:
              a.id = n.readUint32();
            ...
            case 2:
              ...
              break;
            case 6:
              a.fileName = n.readString();
              break;
            case 3:
              a.bytes = n.readUint32();
              break;
            case 4:
              a.chars = n.readPackedUint32();
              break;
            case 5:
              a.duration = n.readUint32();
              break;
            default:
              n.skipField();
          }
    ...
    class l extends i.Message {
      ...
      static fromObject(s) {
        const n = new l({});
        return s.originSize != null && (n.originSize = s.originSize), s.bundledSize != null && (n.bundledSize = s.bundledSize), s.originBytes != null && (n.originBytes = s.originBytes), s.bundledBytes != null && (n.bundledBytes = s.bundledBytes), n;
      }
      toObject() {
        const s = {};
      ...
      serialize(s) {
        const n = s || new i.BinaryWriter();
        if (this.originSize != 0 && n.writeUint32(1, this.originSize), this.bundledSize != 0 && n.writeUint32(2, this.bundledSize), this.originBytes != 0 && n.writeUint32(3, this.originBytes), this.bundledBytes != 0 && n.writeUint32(4, this.bundledBytes), !s)
          return n.getResultBuffer();
      }
      static deserialize(s) {
        const n = s instanceof i.BinaryReader ? s : new i.BinaryReader(s), a = new l();
        for (; n.nextField() && !n.isEndGroup(); )
          switch (n.getFieldNumber()) {
            case 1:
              a.originSize = n.readUint32();
              break;
            case 2:
              a.bundledSize = n.readUint32();
              break;
            case 3:
              a.originBytes = n.readUint32();
              break;
            case 4:
              a.bundledBytes = n.readUint32();
              break;
            default:
              n.skipField();
          }
    ...
    class m extends i.Message {
      ...
      static fromObject(s) {
        const n = new m({});
        return s.family != null && (n.family = s.family), s.style != null && (n.style = s.style), s.weight != null && (n.weight = s.weight), s.display != null && (n.display = s.display), n;
      }
      toObject() {
        const s = {};
      ...
      serialize(s) {
        const n = s || new i.BinaryWriter();
        if (this.family.length && n.writeString(1, this.family), this.style.length && n.writeString(2, this.style), this.weight.length && n.writeString(3, this.weight), this.display.length && n.writeString(4, this.display), !s)
          return n.getResultBuffer();
      }
      static deserialize(s) {
        const n = s instanceof i.BinaryReader ? s : new i.BinaryReader(s), a = new m();
        for (; n.nextField() && !n.isEndGroup(); )
          switch (n.getFieldNumber()) {
            case 1:
              a.family = n.readString();
              break;
            case 2:
              a.style = n.readString();
              break;
            case 3:
              a.weight = n.readString();
              break;
            case 4:
              a.display = n.readString();
              break;
            default:
              n.skipField();
          }
    ...
    u.Css = m;
  })(o = g.OutputReport || (g.OutputReport = {}));
})(d || (d = {}));
export {
  d as api_interface
};
