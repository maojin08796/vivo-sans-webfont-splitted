...
import fs from 'fs';
import { snakeCase } from '../node_modules/.pnpm/change-case@5.4.4/node_modules/change-case/dist/index.mjs';
...
`;
  ...
  function createFlatDefine(fields2, parentKey = "") {
    ...
    pub ${snakeCase(capitalizeAfterDot(longName))}: ${isOption ? `Option<${placeholder}>` : placeholder},
`
      ];
    });
  }
...
export { genClapCode };
//# sourceMappingURL=genClapCode.mjs.map
